...
class KabusAPIClient:
    ...
    def get_market_price(self, symbols: List[str]) -> Dict[str, float]:
        ...
        for symbol in symbols:
            try:
                # For now, use yfinance as fallback since KabusAPI might not have these ETFs
    ...
    def place_order(self, 
        ...
        try:
            ...
            if result.get('ResultCode') == 0:
                ...
                print(f"Order failed: {result.get('ResultText', 'Unknown error')}")
                return None
